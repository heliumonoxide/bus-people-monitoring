...
// Camera OV2640 for ESP32-WROVER
...
// Before upload to your esp32. make sure you use this in tools:
// ESP32-WROVER-KIT all version as board. Use OPI PSRAM (as PSRAM). the rest use default.
