  ...
  useEffect(() => {
    const fetchHighestCount = async () => {
      try {
        ...
        const response = await fetch('https://webapi-bus-monitoring.vercel.app/api/highest'); // Assuming this is the endpoint
      ...
      <div className="max-w-sm w-full bg-white shadow-lg rounded-lg overflow-hidden">
        ...
        <div className="px-6 py-3 flex flex-col items-center">
          {error ? (
            ...
            <>
              <p className="text-2xl font-extrabold text-blue-500 ">{highestCount}</p>
